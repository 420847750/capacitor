...
<head>
	<meta charset="UTF-8">
	<title>修改密码</title>
	<link type="text/css" rel="stylesheet" href="${base}/battery/css/dianchi.css">
					...
					<form id="form" action="${base}/safe/save.action" method="post">
						<div class="newDetail">
							<div class="enterprise">
								...
								<div class="enterpriseInput">
									<input name="oldpassword" id="oldpassword" type="password">
									<span style="color: red; margin-right: 10px;">*</span><span
										id="old" class="errorspan"></span>
								</div>
							</div>
							<div class="enterprise">
								<div class="enterpriseText">
								...
								<div class="enterpriseInput">
									<input name="password" id="password" type="password"> <span
										style="color: red; margin-right: 10px;">*</span><span id="new"
							...
							<div class="enterprise">
								...
								<div class="enterpriseInput">
									<input name="reword" id="reword" type="password"> <span
										style="color: red; margin-right: 10px;">*</span><span id="re"
										class="errorspan"></span>
								</div>
							</div>
							...
							<div class="enterprise2">
								...
								<div class="enterpriseCheck">
									<a href="javascript:void(0);" onclick="save();"
										class="auditPass">确认</a>
									 <a href="${base}/main.action" class="return">返回</a>
								</div>
							</div>
						</div>
					</form>
...
<script>
		...
		var data = sessionStorage.getItem('sessionflag2');
